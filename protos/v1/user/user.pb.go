...
type UserMessage struct {
	...
	UserDetail  *UserDetailMessage `protobuf:"bytes,5,opt,name=user_detail,json=userDetail,proto3" json:"user_detail,omitempty"`
}
...
func (x *UserMessage) GetUserDetail() *UserDetailMessage {
	if x != nil {
		return x.UserDetail
	}
	return nil
...
var file_protos_v1_user_user_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x65, 0x72, 0x1a, 0x11, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	...
	0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x3a, 0x0a, 0x0b, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19,
	0x2e, 0x76, 0x70, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x44,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x29, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x6e, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
...
var file_protos_v1_user_user_proto_goTypes = []interface{}{
	...
	(*UserDetailMessage)(nil), // 5: vpdata.UserDetailMessage
}
var file_protos_v1_user_user_proto_depIdxs = []int32{
	5, // 0: v1.user.UserMessage.user_detail:type_name -> vpdata.UserDetailMessage
	0, // 1: v1.user.GetUserResponse.user_message:type_name -> v1.user.UserMessage
	0, // 2: v1.user.ListUsersResponse.user_messages:type_name -> v1.user.UserMessage
	1, // 3: v1.user.User.GetUser:input_type -> v1.user.GetUserRequest
	3, // 4: v1.user.User.ListUsers:input_type -> v1.user.ListUsersRequest
	2, // 5: v1.user.User.GetUser:output_type -> v1.user.GetUserResponse
	4, // 6: v1.user.User.ListUsers:output_type -> v1.user.ListUsersResponse
